...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ud_handle = ud;
       ...
       Current_X1 = ud.h_motor_Left.GetPosition_Position(0)
        Current_Y1 = ud.h_motor_Right.GetPosition_Position(0)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         
   Current_X = ud.h_motor_Left.GetPosition_Position(0)
                    ...
                    ud.h_motor_Left.SetAbsMovePos(0,(Current_X+Value_dX/(-1)));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
...
%         output = ud.h_motor_Right.MoveRelative(0, true)
         Current_Y = ud.h_motor_Right.GetPosition_Position(0)
                    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
                    ud.h_motor_Right.SetAbsMovePos(0,(Current_Y+Value_dY/(-1)));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
...
%aaa=3000                  
                    ...
                    [Mean_value_area(i,j),Mean_value_max(i,j),Mean_value_max2(i,j),waveform_new]= get_wave(deviceObj_r,nomefile,time_scale, wave);
...
%bbb=3
                    ...
                    Current_X = ud.h_motor_Left.GetPosition_Position(0)
                    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
                    ud.h_motor_Left.SetAbsMovePos(0,(Current_X+Value_step));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
                    output = ud.h_motor_Left.MoveAbsolute(0,1==0);
t1 = clock; % current time
...
%aaa=4            
            ...
            %output = ud.h_motor_Left.MoveRelative(0, true); 
             ...
             Current_X = ud.h_motor_Left.GetPosition_Position(0)
                    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
                    ud.h_motor_Left.SetAbsMovePos(0,(Current_X+Value_step*(n)*(-1)));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
                    output = ud.h_motor_Left.MoveAbsolute(0,1==0);
t1 = clock; % current time
...
Current_Y = ud.h_motor_Right.GetPosition_Position(0)
                    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
                    ud.h_motor_Right.SetAbsMovePos(0,(Current_Y+Value_step));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
                    output = ud.h_motor_Right.MoveAbsolute(0,1==0);
t1 = clock; % current time
...
%     output = ud.h_motor_Left.MoveRelative(0, true);
             ...
             Current_X = ud.h_motor_Left.GetPosition_Position(0)
                    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
                    ud.h_motor_Left.SetAbsMovePos(0,(Current_X+Value_dX));
                   % h.SetAbsMovePos(0,7);
                   % output = ud.h_motor_Left.MoveRelative(0, true);
                    output = ud.h_motor_Left.MoveAbsolute(0,1==0);
t1 = clock; % current time
