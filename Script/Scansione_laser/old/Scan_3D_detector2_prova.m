...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    SetMotor(h_motor_Left, 83815649, ParamSet);
    h_motor_Right = actxcontrol('MGMOTOR.MGMotorCtrl.1', [300 410 300 200], fig);
    SetMotor(h_motor_Right, 83815665, ParamSet);
...
%aaa=3000                  
                    ...
                    [Mean_value_area(i,j),Mean_value_max(i,j),Mean_value_max2(i,j),waveform_new]= get_wave_g(deviceObj_r,nomefile,time_scale, wave);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Current_X = ud.h_motor_Left.GetPosition_Position(0)
    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
    ud.h_motor_Left.SetAbsMovePos(0,Current_X1);
    % h.SetAbsMovePos(0,7);
    % output = ud.h_motor_Left.MoveRelative(0, true);
    output = ud.h_motor_Left.MoveAbsolute(0,1==0);
    ...
    Current_Y = ud.h_motor_Right.GetPosition_Position(0)
    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
    ud.h_motor_Right.SetAbsMovePos(0,Current_Y1);
    % h.SetAbsMovePos(0,7);
    % output = ud.h_motor_Left.MoveRelative(0, true);
    output = ud.h_motor_Right.MoveAbsolute(0,1==0);
