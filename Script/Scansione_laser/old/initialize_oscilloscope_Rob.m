...
interfaceObj = instrfind('Type', 'visa-tcpip', 'RsrcName', 'TCPIP0::10.196.31.183::inst0::INSTR', 'Tag', '');

% controllo all'avvio dell'oggetto connesso all'oscilloscopio (codice commentabile)
% Create the VISA-TCPIP object if it does not exist
% otherwise use the object that was found.
if isempty(interfaceObj)
    interfaceObj = visa('NI', 'TCPIP0::10.196.31.183::inst0::INSTR');
else
    fclose(interfaceObj);
...
deviceObj = icdevice('tkdpo4k.mdd', 'TCPIP0::10.196.31.183::inst0::INSTR');
