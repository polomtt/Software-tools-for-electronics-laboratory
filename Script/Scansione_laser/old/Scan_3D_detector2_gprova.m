...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Default_X1 = ud.h_motor_Left.GetPosition_Position(0)
    Default_Y1 = ud.h_motor_Right.GetPosition_Position(0)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Current_X = ud.h_motor_Left.GetPosition_Position(0)
    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
    ud.h_motor_Left.SetAbsMovePos(0,Default_X1);
    % h.SetAbsMovePos(0,7);
    % output = ud.h_motor_Left.MoveRelative(0, true);
    output = ud.h_motor_Left.MoveAbsolute(0,1==0);
    ...
    Current_Y = ud.h_motor_Right.GetPosition_Position(0)
    %ud.h_motor_Left.SetRelMoveDist(0, Value_step); %muovo il motore di sinistra (asse X) di uno step verso destra
    ud.h_motor_Right.SetAbsMovePos(0,Default_Y1);
    % h.SetAbsMovePos(0,7);
    % output = ud.h_motor_Left.MoveRelative(0, true);
    output = ud.h_motor_Right.MoveAbsolute(0,1==0);
